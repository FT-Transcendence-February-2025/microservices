    ...
    async getHtml() {
        ...
        <div class="h-screen w-screen flex justify-center items-center bg-[url('/images/background.jpg')] bg-cover bg-no-repeat">
            <form id="registerForm" class="bg-white p-6 rounded-lg">
                <label for="displayName" class="block text-sm font-bold mb-2">Display Name:</label>
                <input type="text" id="displayName" name="displayName" required class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-600 mb-4">
